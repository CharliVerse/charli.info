...
- explain the phrase answer-shaped object in ordinary language;
- separate the confidence and polish of an answer from its reliability;
- judge an AI response in relation to the task, the stakes and the available alternatives;
- recognise when an answer is useful as a starting point and when it needs independent checking or professional expertise; and
- keep human judgement as the load-bearing part of the process.
...
- **The shape of the thing:** Why a fluent response resembles knowledge without guaranteeing it.
- **The Eiffel Tower test:** How an AI can construct a useful description without seeing or remembering.
- **Useful compared with what?:** Why the real alternative may be no description, no explanation or no accessible route into the subject.
- **The hard cases:** Why plausibility becomes dangerous when the recipient lacks the knowledge needed to test it.
- **Dead reckoning:** A practical way to think about estimates, drift and different kinds of water.
- **The human layer:** Why experience, context and judgement remain load-bearing.
- **Dismissal-shaped objects:** Why blanket rejection can avoid the same careful evaluation that blind acceptance avoids.
- **What we actually get:** A position between treating AI as truth and treating it as worthless noise.
...
This handbook is licensed under the [Creative Commons Attribution 4.0 International licence](https://creativecommons.org/licenses/by/4.0/) (CC BY 4.0). You may copy, share, adapt and use it for any purpose, including commercially, provided that you credit the author.
